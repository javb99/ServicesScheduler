...
struct KeychainPasswordItem {
    ...
    func readSecureData() throws -> Data {
        /*
    ...
    func readPassword() throws -> String  {
        /*
            ...
            access group.
        */
        let secureData = try readSecureData()
        guard let password = String(data: secureData, encoding: String.Encoding.utf8) else {
            throw KeychainError.unexpectedPasswordData
        }
        return password
    }
    ...
    func savePassword(_ password: String) throws {
        ...
        try saveData(password.data(using: String.Encoding.utf8)!)
    }
